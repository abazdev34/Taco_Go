...
function AdminMonitor() {
  ...
  const loadOrders = async () => {
    try {
      ...
      console.error(err);
      setError("Заказларды жүктеу кезінде қате шықты");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCommentSave = async (id: string, comment: string) => {
    try {
      ...
      console.error(err);
      alert("Комментарийді сақтау мүмкін болмады");
    } finally {
      setSavingId(null);
    }
  };
    ...
    <div style={styles.page}>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Заказдарды толық басқару</p>
        </div>
      ...
      <div style={styles.statsGrid}>
        <div style={styles.statCard}>
          <div style={styles.statLabel}>Барлығы</div>
      ...
      {loading && <div style={styles.message}>Жүктелуде...</div>}
      {!!error && <div style={styles.error}>{error}</div>}

      {!loading && !orders.length && (
        <div style={styles.empty}>Заказ табылмады</div>
      )}
...
function OrderCard({
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.section}>
        <div style={styles.sectionTitle}>Тауарлар</div>
