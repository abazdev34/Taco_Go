			...
			>
				<div className='kitchen-order-card__top'>
					...
					<div className='kitchen-badges'>
						{isNewKitchenOrder && (
							<span className='kitchen-badge new'>Новый</span>
						)}
						...
						{hasAssembly && <span className='kitchen-badge assembly'>Сборка</span>}
					</div>
				</div>
				...
				{order.comment && (
					<div className='kitchen-comment'>💬 {order.comment}</div>
				)}
